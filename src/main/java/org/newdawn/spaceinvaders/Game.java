...
public class Game extends Canvas implements GameWindowCallback {
	protected static final long serialVersionUID = 8954895920070574816L;
	...
	protected boolean logicRequiredThisLoop = false;

	/** The time at which the last rendering looped started from the point of view of the game logic */
	protected long lastLoopTime = SystemTimer.getTime();
	/** The window that is being used to render the game */
	protected GameWindow window;
	/** True if the fire key has been released */
	protected boolean fireHasBeenReleased = false;
	
	/** The sprite containing the "Press Any Key" message */
	protected Sprite pressAnyKey;
	/** The sprite containing the "You win!" message */
	protected Sprite youWin;
	/** The sprite containing the "You lose!" message */
	protected Sprite gotYou;
	...
	protected String windowTitle = "Space Invaders 104 - Version (0.4)";
	...
	public Game(int renderingType) {
		...
		// DO NOTHING AS THIS IS GOING TO BE OVERRIDDEN FOR INJECTION
